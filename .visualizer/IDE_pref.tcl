...
set perspective_DateTime   {2025-03-05T17:54:27}
set perspective_Directory  {D:/Digital_Design/Project_1}
set perspective_USER       {Karim Maaty}
...
pref::set -type string -category General -name IDEVisibleWindows -value Lint###zinlintDesignMetricsView,transcript,zinlintMsgDashboardView,zindetails,zinlintMsgView,zinlintMsgSummaryView,zinlintMsgStatusHistoryView,zincdcdutview,zinmsgviewer,zinflownavigator,zinlintDesignInfoView,source -hide -description none -label none
...
pref::set -type string -category Lint -name compileMsgViewColumnOrderWidth -value Severity:129,Message:125,Backref:125 -hide -description none -label none
...
pref::set -type string -category Lint -name lintMessagesviewToolButtonFiltersTuple -value Check!-!Equals!-!gen_label_missing!@!Severity!-!Equals!-!Info!@!State!-!Equals!-!open!@!Status!-!Equals!-!pending!@!Status!-!Equals!-!uninspected!@!Status!-!Equals!-!bug!@!Status!-!Equals!-!waived -hide -description none -label none
